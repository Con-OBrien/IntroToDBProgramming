...
@Entity
@Table(name = "view_Trainer1WinCheck", schema = "dbo", catalog = "Pokemon")
public class ViewTrainer1WinCheckEntity {
    ...
    public boolean equals(Object o) {
        ...
        ViewTrainer1WinCheckEntity that = (ViewTrainer1WinCheckEntity) o;
